...
{
    internal class DesignTimeServicesExtensionInfo : DbContextOptionsExtensionInfo
    {
        /// <summary>
        ...
        public DesignTimeServicesExtensionInfo(IDbContextOptionsExtension extension) : base(extension)
        {
        }
        ...
        /// </summary>
        public override string LogFragment => "Design Time Services";
    }
}